...
output "backup_policy_vms_backup" {
  ...
  value       = { for k, v in azurerm_backup_policy_vm.backup_policy_vms : k => one(v.backup) if v.backup != null && length(v.backup) > 0 }
}
...
output "backup_policy_vms_instant_restore_resource_group" {
  ...
  value       = { for k, v in azurerm_backup_policy_vm.backup_policy_vms : k => one(v.instant_restore_resource_group) if v.instant_restore_resource_group != null && length(v.instant_restore_resource_group) > 0 }
}
...
output "backup_policy_vms_retention_daily" {
  ...
  value       = { for k, v in azurerm_backup_policy_vm.backup_policy_vms : k => one(v.retention_daily) if v.retention_daily != null && length(v.retention_daily) > 0 }
}
output "backup_policy_vms_retention_monthly" {
  ...
  value       = { for k, v in azurerm_backup_policy_vm.backup_policy_vms : k => one(v.retention_monthly) if v.retention_monthly != null && length(v.retention_monthly) > 0 }
}
output "backup_policy_vms_retention_weekly" {
  ...
  value       = { for k, v in azurerm_backup_policy_vm.backup_policy_vms : k => one(v.retention_weekly) if v.retention_weekly != null && length(v.retention_weekly) > 0 }
}
output "backup_policy_vms_retention_yearly" {
  ...
  value       = { for k, v in azurerm_backup_policy_vm.backup_policy_vms : k => one(v.retention_yearly) if v.retention_yearly != null && length(v.retention_yearly) > 0 }
}
output "backup_policy_vms_tiering_policy" {
  ...
  value       = { for k, v in azurerm_backup_policy_vm.backup_policy_vms : k => one(v.tiering_policy) if v.tiering_policy != null && length(v.tiering_policy) > 0 }
}
